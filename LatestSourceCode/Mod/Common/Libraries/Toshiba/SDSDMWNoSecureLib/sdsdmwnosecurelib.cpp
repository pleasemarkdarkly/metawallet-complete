...
//// see SDSDMWNoSecureLib.h for the class definition
...
//// Test Wrapper
//SDSDMWLIB_API SSS_STS SDSDMWNoSecure_Open(void)
//{
//	return SSS_Open();
//}
...
SDSDMWLIB_API
SSS_STS SDSDMWNoSecure_GetMediaTimeStamp(
...
SDSDMWLIB_API
SSS_STS SDSDMWNoSecure_WriteContentEx(
    SSS_STR*        ContentRootPath,        /* Media Path(Content) */
    SSS_STR*        Content,                /* Content file path */
...
SDSDMWLIB_API
SSS_STS SDSDMWNoSecure_SeekStreamEx(
    SSS_SHNDL       StreamHandle,           /* Stream Handle */
    SSS_LONG        OffsetTime,             /* Offset Time */
    SSS_ULONG       Origin,                 /* Origin */
