...
//  The range for each parameter
    ...
    // the modes are the same for the audio and video
    TCHAR *ModeRange[] = {
...
int RemapAudioParams( AudioEncParams *pParams ){
    ...
    if( 0 == _tcsicmp( pParams->pszSpeechMode, AudioTypeRange[1] ) ){ // auto
