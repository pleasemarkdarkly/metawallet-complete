...
/* interface __MIDL_itf_mswmdm_0300 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_mswmdm_0300_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mswmdm_0300_v0_0_s_ifspec;
...
/* interface __MIDL_itf_mswmdm_0319 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_mswmdm_0319_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mswmdm_0319_v0_0_s_ifspec;
...
EXTERN_C const IID IID_ISCPSecureAuthenticate2;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE GetSCPSession( 
            /* [out] */ ISCPSession **ppSCPSession) = 0;
...
HRESULT STDMETHODCALLTYPE ISCPSecureAuthenticate2_GetSCPSession_Proxy( 
    ISCPSecureAuthenticate2 * This,
    /* [out] */ ISCPSession **ppSCPSession);


void __RPC_STUB ISCPSecureAuthenticate2_GetSCPSession_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISCPSecureExchange2_TransferContainerData2_Proxy( 
    ISCPSecureExchange2 * This,
    /* [size_is][in] */ BYTE *pData,
    /* [in] */ DWORD dwSize,
    /* [in] */ IWMDMProgress3 *pProgressCallback,
...
void __RPC_STUB ISCPSecureExchange2_TransferContainerData2_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
EXTERN_C const IID IID_ISCPSecureExchange3;
    ...
    public:
        virtual HRESULT STDMETHODCALLTYPE TransferContainerDataOnClearChannel( 
            /* [in] */ IMDSPDevice *pDevice,
            /* [size_is][in] */ BYTE *pData,
            /* [in] */ DWORD dwSize,
            /* [in] */ IWMDMProgress3 *pProgressCallback,
            /* [out] */ UINT *pfuReadyFlags) = 0;
...
HRESULT STDMETHODCALLTYPE ISCPSecureExchange3_TransferContainerDataOnClearChannel_Proxy( 
    ISCPSecureExchange3 * This,
    /* [in] */ IMDSPDevice *pDevice,
    /* [size_is][in] */ BYTE *pData,
    /* [in] */ DWORD dwSize,
...
void __RPC_STUB ISCPSecureExchange3_TransferContainerDataOnClearChannel_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISCPSecureExchange3_GetObjectDataOnClearChannel_Proxy( 
    ISCPSecureExchange3 * This,
    /* [in] */ IMDSPDevice *pDevice,
    /* [size_is][out] */ BYTE *pData,
    /* [out][in] */ DWORD *pdwSize);
...
void __RPC_STUB ISCPSecureExchange3_GetObjectDataOnClearChannel_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISCPSecureExchange3_TransferCompleteForDevice_Proxy( 
    ISCPSecureExchange3 * This,
    /* [in] */ IMDSPDevice *pDevice);


void __RPC_STUB ISCPSecureExchange3_TransferCompleteForDevice_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISCPSession_BeginSession_Proxy( 
    ISCPSession * This,
    /* [in] */ IMDSPDevice *pIDevice,
    /* [size_is][in] */ BYTE *pCtx,
    /* [in] */ DWORD dwSizeCtx);
...
void __RPC_STUB ISCPSession_BeginSession_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISCPSession_EndSession_Proxy( 
    ISCPSession * This,
    /* [size_is][in] */ BYTE *pCtx,
    /* [in] */ DWORD dwSizeCtx);


void __RPC_STUB ISCPSession_EndSession_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISCPSession_GetSecureQuery_Proxy( 
    ISCPSession * This,
    /* [out] */ ISCPSecureQuery **ppSecureQuery);


void __RPC_STUB ISCPSession_GetSecureQuery_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
EXTERN_C const IID IID_ISCPSecureQuery3;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE MakeDecisionOnClearChannel( 
            ...
            /* [unique][out][in] */ ULONGLONG *pqwFileSize,
            /* [in] */ IUnknown *pUnknown,
            /* [out] */ ISCPSecureExchange **ppExchange) = 0;
...
HRESULT STDMETHODCALLTYPE ISCPSecureQuery3_GetRightsOnClearChannel_Proxy( 
    ISCPSecureQuery3 * This,
    /* [size_is][in] */ BYTE *pData,
    /* [in] */ DWORD dwSize,
    /* [size_is][in] */ BYTE *pbSPSessionKey,
...
void __RPC_STUB ISCPSecureQuery3_GetRightsOnClearChannel_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
HRESULT STDMETHODCALLTYPE ISCPSecureQuery3_MakeDecisionOnClearChannel_Proxy( 
    ISCPSecureQuery3 * This,
    /* [in] */ UINT fuFlags,
    /* [size_is][in] */ BYTE *pData,
    /* [in] */ DWORD dwSize,
...
void __RPC_STUB ISCPSecureQuery3_MakeDecisionOnClearChannel_Stub(
    IRpcStubBuffer *This,
    IRpcChannelBuffer *_pRpcChannelBuffer,
    PRPC_MESSAGE _pRpcMessage,
    DWORD *_pdwStubPhase);
...
/* interface __MIDL_itf_mswmdm_0328 */
/* [local] */ 

#define SAC_MAC_LEN 8


extern RPC_IF_HANDLE __MIDL_itf_mswmdm_0328_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mswmdm_0328_v0_0_s_ifspec;
...
/* interface __MIDL_itf_mswmdm_0329 */
/* [local] */ 

const GUID EVENT_WMDM_CONTENT_TRANSFER = { 0x339C9BF4, 0xBCFE, 0x4ED8, { 0x94, 0xDF,  0xEA,  0xF8,  0xC2,  0x6A,  0xB6,  0x1B } };


extern RPC_IF_HANDLE __MIDL_itf_mswmdm_0329_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_mswmdm_0329_v0_0_s_ifspec;
