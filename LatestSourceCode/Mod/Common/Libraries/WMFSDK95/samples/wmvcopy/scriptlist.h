...
public:
    ...
    HRESULT Initial( WCHAR *pwszType,           // Script command type
                     WCHAR *pwszParameter,      // Script command parameter
                     QWORD cnsTime )            // Script command time
    {
        ...
        wcscpy( m_pwszParameter, pwszParameter );
        m_cnsTime = cnsTime;
...
public:
    ...
    //////////////////////////////////////////////////////////////////////////////////
    HRESULT AddScript( WCHAR *pwszType,         // Script command type
                       WCHAR *pwszParameter,    // Script command parameter
                       QWORD cnsTime )          // Script command time
    {
