...
namespace MOD.Test
{
	...
	// ------------------------------------------------------------------------------
	[Serializable]
	public class TestException : MOD.Exceptions.CustomAppException
	{
		// for ErrorType property
		private TestErrorType _errorType = TestErrorType.Unknown;
		...
		/// </param>
		// ------------------------------------------------------------------------------
		public TestException(TestErrorType errorType, string message, Exception innerException) : base(message,innerException)
		{
			ErrorType = errorType;
		}
		...
		// ------------------------------------------------------------------------------
		[XmlElementAttribute()]
		public virtual TestErrorType ErrorType
		{
			get
			{
				return _errorType;
