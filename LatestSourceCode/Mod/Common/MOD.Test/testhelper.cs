...
namespace MOD.Test
{
	public static class TestHelper
	{
        ...
        public static string GetTestErrorTypeString(TestErrorType errType)
		{
			switch (errType)
			{
                case TestErrorType.Info:
                    return "Information";

				case TestErrorType.Warning:
					return "Warning";

				case TestErrorType.Validation:
					return "Validation error";

				case TestErrorType.Performance:
					return "Performance error";

				case TestErrorType.Functional:
        ...
        public static string GetTestPerformanceLevelString(TestPerformanceLevel perfLevel)
        {
            switch (perfLevel)
            {
                case TestPerformanceLevel.Good:
                    return "Good performance";

                case TestPerformanceLevel.Fair:
                    return "Fair performance";

                case TestPerformanceLevel.Tolerable:
                    return "Tolerable performance";

                case TestPerformanceLevel.Annoying:
                    return "Annoying performance";

                case TestPerformanceLevel.Painful:
                    return "Painful performance";

                case TestPerformanceLevel.Unacceptable:
		...
		// ------------------------------------------------------------------
		public static TestFailureLevel GetTestFailureLevelForErrorType(TestErrorType errType)
		{
			switch (errType)
			{
                case TestErrorType.Info:
                    return TestFailureLevel.Success;
				case TestErrorType.Warning:
				case TestErrorType.Validation:
				case TestErrorType.Performance:
					return TestFailureLevel.Warning;
				case TestErrorType.Functional:
					return TestFailureLevel.Error;
				default:
					return TestFailureLevel.None;
			}
        }
        ...
        // ------------------------------------------------------------------
        public static TestErrorType GetTestErrorTypeForPerformanceLevel(TestPerformanceLevel perfLevel)
        {
            switch (perfLevel)
            {
                case TestPerformanceLevel.Good:
                case TestPerformanceLevel.Fair:
                case TestPerformanceLevel.Tolerable:
                    return TestErrorType.Info;
                case TestPerformanceLevel.Annoying:
                case TestPerformanceLevel.Painful:
                case TestPerformanceLevel.Unacceptable:
                    return TestErrorType.Performance;
                default:
                    return TestErrorType.Unknown;
            }
        }

        public static TestPerformanceLevel GetPerformanceLevelFromTime(double actualTime, double[] timeLevels)
        {
            if (timeLevels == null)
            {
            ...
            if (timeLevels.Length < ((int)TestPerformanceLevel.PerformanceLevelCount - 1))
            {
            ...
            int iLeftIndex = 0;
            int iRightIndex = (int)TestPerformanceLevel.PerformanceLevelCount - 2;
            
            if (actualTime < timeLevels[iLeftIndex])
            {
                return TestPerformanceLevel.Good;
            }

            if (actualTime > timeLevels[iRightIndex])
            {
                return TestPerformanceLevel.Unacceptable;
            }
            ...
            return (TestPerformanceLevel)(iRightIndex + 1);           
        }
