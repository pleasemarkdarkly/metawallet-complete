...
namespace MOD.Data
{
	...
	public class MySqlManager
	{
		...
		protected MySqlProcAdapter _adapter = null;
		...
		// ------------------------------------------------------------------------------
		public MySqlProcAdapter GetAdapter(int debugLevel, DatabaseOptions dbOptions)
		{
			// Validate parameters
			if (dbOptions == null)
			...
			lock (s_lock)
			{
				_adapter = new MySqlProcAdapter(dbOptions.CommandTimeout);
			}

			_adapter.Connection = new MySqlConnection(dbOptions.ConnectionString);
