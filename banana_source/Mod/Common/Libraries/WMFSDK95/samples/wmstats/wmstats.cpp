...
///////////////////////////////////////////////////////////////
static void Usage();
static HRESULT CommandLineParser( int argc, TCHAR* argv[], TCHAR** ptszInput, TCHAR** ptszOutput, int &iMode, DWORD &dwPortNum );
#ifndef UNICODE
static HRESULT ConvertStrToUnicode( TCHAR*    ptszInput, WCHAR** pwszInput );
#endif
...
///////////////////////////////////////////////////////////////
////////
HRESULT CommandLineParser( int argc, TCHAR* argv[], TCHAR** ptszInput, TCHAR** ptszOutput, int &iMode, DWORD &dwPortNum )
{
    ...
    *ptszOutput           = NULL;
    ...
    for( int i = 1; i < argc; i ++ )
    {
        ...
        if( 0 == _tcsicmp( argv[i] , _T( "-t" ) ) )
        {
            ...
            int nDelay = 0;
            int ret = _stscanf( argv[i], _T( "%d" ), &nDelay ) ;
    ...
    else if ('s' == *ptszMode || 'S' == *ptszMode)
    {
        ...
        if (NULL != *ptszOutput)
		{
			int ret = _stscanf( *ptszOutput, _T( "%d" ), &dwPortNum ) ;
...
///////////////////////////////////////////////////////////////
///////
HRESULT ConvertStrToUnicode( TCHAR* ptszInput, WCHAR** ppwszInput )
{
    HRESULT hr = S_OK;
    int nSizeCount = 0 ;
