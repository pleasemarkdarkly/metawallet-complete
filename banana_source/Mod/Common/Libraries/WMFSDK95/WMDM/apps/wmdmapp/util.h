...
LPWSTR GetRegStr(LPWSTR szPath, LPWSTR szKey, LPWSTR szDefault, BOOL bStore);
LPWSTR GetRegStr_StrTbl(UINT uPathID, UINT uKeyID, LPWSTR szDefault, BOOL bStore);
LPWSTR GetRegStr_StrTblDefault(UINT uPathID, UINT uKeyID, UINT uDefaultID, BOOL bStore);
